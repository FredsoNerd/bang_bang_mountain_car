...
def run(episodes = 100, train = True, render = True, epsilon_0 = 0.2,
        alpha = 0.9, gamma = 0.9, obs_space_pos_n = 20, obs_space_vel_n = 20,
...
run(episodes=1000, train=True, render=False, epsilon_0=10,
    q_table_file = "mcar_discrete_q_table.pkl",
    rewards_plot_file = "mcar_discrete_learn_rewards_plot")

# generate actions histogram from trained table
run(episodes=200, train=False, render=False,
    q_table_file = "mcar_discrete_q_table.pkl",
    rewards_plot_file = "mcar_discrete_trained_rewards_plot",
    actions_hist_file = "mcar_discrete_trained_actions_hist")

# render running examples from trained table
run(episodes=5, train=False, render=True,
    q_table_file = "mcar_discrete_q_table.pkl")